...
type1 dimension: simply updates the address when changes occur, overwriting the previous value. the CUSTOMER_ADDRESS table will have a one to one relationship in this case ,
